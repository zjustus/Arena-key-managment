<%@ Control Language="c#" Inherits="ArenaWeb.UserControls.custom.Luminate.DoorAccess.Locations" CodeFile="doorAccess_locations.ascx.cs" %>
...
<asp:Panel ID="pnlReports" Runat="server" CssClass="card card-accent-primary">
    <div class="card-block">
        ...
        <div class="table-responsive">
            <Arena:DataGrid id="dgLocations" DataKeyField="location_id" Runat="server" AllowSorting="true">
                <Columns>
