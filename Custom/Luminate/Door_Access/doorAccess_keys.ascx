<%@ Control Language="c#" Inherits="ArenaWeb.UserControls.custom.Luminate.DoorAccess.Keys" CodeFile="doorAccess_keys.ascx.cs" %>

<asp:Panel ID="pnlReports" Runat="server" CssClass="card card-accent-primary">
    <div class="card-block">
        <asp:LinkButton ID="lbAdd" Runat="server" CssClass="btn btn-primary" Visible="False" Text="Add New Key" />
        <div class="table-responsive">
            <Arena:DataGrid id="dgKeys" DataKeyField="location_id" Runat="server" AllowSorting="true">
                <Columns>
        ...
        <asp:Panel ID="pnlAdvanceReport" runat="server">
            <div class="text-right clear-padding">
                <asp:LinkButton ID="imgBtnAddRpt" runat="server" ToolTip="Add new Key">
                    <i class="fa-stack">
